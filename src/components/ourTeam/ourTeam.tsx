                    ...
                    <div className="w-full grid xl:grid-cols-5 grid-cols-2 space-y-8 xl:space-y-0 space-x-2 xl:space-x-1">
                        ...
                        <div className="flex-1 space-y-5">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <p className="text-xs">With an MBA in marketing & strategic planning and over 25 years of sales and marketing experience, Karen has helped her clients increase their market share and revenues. She has developed and managed successful B2B and B2C campaigns that drive results.</p>
                            </div>
                        </div>
                        <div className="flex-1 space-y-5">
