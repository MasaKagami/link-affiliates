                    ...
                    <div className="w-full grid xl:grid-cols-5 grid-cols-2 space-x-4 xl:space-x-4">
                        ...
                        <div className="flex-1 space-y-5 my-4">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <p className="hidden sm:flex text-xs">With an MBA in marketing & strategic planning and over 25 years of sales and marketing experience, Karen has helped her clients increase their market share and revenues. She has developed and managed successful B2B and B2C campaigns that drive results.</p>
                            </div>
                        </div>
                        <div className="flex-1 space-y-5 my-4">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="sm:flex flex-col gap-2 hidden text-xs">
                        ...
                        <div className="flex-1 space-y-5 my-4">
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex flex-col gap-2">
                                    <h1 className={`text-2xl font-bold ${merriweather.className} `}>Tim Choi</h1>
